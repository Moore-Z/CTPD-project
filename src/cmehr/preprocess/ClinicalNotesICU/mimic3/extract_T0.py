...
mimic_iii_benchmark_path = "/Users/haochengyang/Desktop/Research/CTPD/MMMSPG-014C/EHR_dataset/mimiciii_benchmark/root"
# 根据train test set修改
split = "train"
test_starttime_path = os.path.join(mimic_iii_benchmark_path, f"{split}_text_fixed", f"{split}_starttime.pkl")
