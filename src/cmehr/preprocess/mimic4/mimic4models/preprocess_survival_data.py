...
from fairehr.preprocess.mimic4.mimic4benchmark.readers import SurvivalReader, Reader
from fairehr.preprocess.mimic4.mimic4models.preprocessing import Normalizer
import fairehr.preprocess.mimic4.mimic4models.common_utils as common_utils
from fairehr.preprocess.mimic4.mimic4models.preprocessing import Discretizer
from fairehr.preprocess.mimic4.mimic4models.text_utils import TextReader
from fairehr.paths import *
...
class Discretizer_multi(Discretizer):
    ...
    def __init__(self, timestep=0.8, store_masks=True, impute_strategy='zero', start_time='zero',
                 config_path=str(
                     ROOT_PATH / "fairehr/resources/mimic4/discretizer_config.json"),
                 channel_path=str(
                     ROOT_PATH / "fairehr/resources/mimic4/channel_info.json")
                 ):
...
def create_irregular_ts():
    config_path = ROOT_PATH / "fairehr/resources/mimic4/discretizer_config.json"
    ...
    normalizer_state = str(
        ROOT_PATH /
        f"fairehr/ext/mimic4models/in_hospital_mortality/ihm_ts{args.timestep}.input_str:{args.imputation}.start_time:zero.normalizer"
    )
